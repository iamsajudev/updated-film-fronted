                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                onBlur={() => setFocusedField(null)}
                                className={`w-full pl-12 pr-4 py-3 text-gray-900 bg-white border-2 rounded-xl focus:outline-none transition-all duration-300 ${
                                    focusedField === 'phone'
                                        ? 'border-purple-500 shadow-lg shadow-purple-100'
                                        : 'border-gray-200 hover:border-gray-300'
                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                onBlur={() => setFocusedField(null)}
                                className="w-full pl-12 pr-4 py-3 text-gray-900 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:border-purple-500 focus:shadow-lg focus:shadow-purple-100 transition-all duration-300 hover:border-gray-300"
                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            <select
                                ...
                                onBlur={() => setFocusedField(null)}
                                className="w-full pl-12 pr-10 py-3 text-gray-900 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:border-purple-500 focus:shadow-lg focus:shadow-purple-100 transition-all duration-300 appearance-none cursor-pointer hover:border-gray-300"
                            >

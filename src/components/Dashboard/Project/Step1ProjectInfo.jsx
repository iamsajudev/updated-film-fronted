    ...
    return (
        ...
        >
            ...
            <div className="space-y-6">
                ...
                >
                    <label className="block text-sm font-semibold text-gray-300 mb-2">
                        Project Type <span className="text-[#1EB97A]">*</span>
                    </label>
                    <div className="relative">
                        <select
                            ...
                            className={`w-full px-5 py-3 bg-gray-800 border-2 rounded-xl focus:outline-none transition-all duration-300 appearance-none cursor-pointer text-white ${
                ...
                >
                    <label className="block text-sm font-semibold text-gray-300 mb-2">
                        Project Title <span className="text-[#1EB97A]">*</span>
                    </label>
                    <div className="relative">
                ...
                >
                    <label className="block text-sm font-semibold text-gray-300 mb-2">
                        Brief Synopsis <span className="text-[#1EB97A]">*</span>
                    </label>
                    <div className="relative">
                        <textarea
                            ...
                            onBlur={() => setFocusedField(null)}
                            rows={5}
                            className={`w-full px-5 py-3 bg-gray-800 border-2 rounded-xl focus:outline-none transition-all duration-300 resize-none text-white placeholder-gray-500 ${
                    ...
                    <div className="flex justify-between mt-2">
                        <div className="flex gap-2 flex-1 mr-4">
                            {[0, 25, 50, 75, 100].map((percent) => {
                                const threshold = percent === 0 ? 0 : percent === 25 ? 125 : percent === 50 ? 250 : percent === 75 ? 375 : 500;
                                return (
                                    <div
                                        key={percent}
                    ...
                    {formData.briefSynopsis.length > 450 && formData.briefSynopsis.length <= 500 && (
                        <p className="text-yellow-500 text-xs mt-1">
                            ⚠️ Getting close to the 500 character limit
                        </p>
                    )}
                    {formData.briefSynopsis.length > 500 && (
                ...
                <AnimatePresence>
                    {formData.hasNonEnglishTitle && (
                        <motion.div
                            ...
                            className="space-y-4 pl-6 border-l-2 border-gradient-to-b from-[#1EB97A] to-emerald-500 overflow-hidden"
                        >
                            <div>
                                <label className="block text-sm font-semibold text-gray-300 mb-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-5 py-3 bg-gray-800 border-2 border-gray-700 rounded-xl focus:outline-none focus:border-[#1EB97A] focus:shadow-lg focus:shadow-[#1EB97A]/20 transition-all duration-300 text-white placeholder-gray-500"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    className="w-full px-5 py-3 bg-gray-800 border-2 border-gray-700 rounded-xl focus:outline-none focus:border-[#1EB97A] focus:shadow-lg focus:shadow-[#1EB97A]/20 transition-all duration-300 resize-none text-white placeholder-gray-500"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-3 bg-gray-800 border-2 border-gray-700 rounded-xl focus:outline-none focus:border-[#1EB97A] focus:shadow-lg focus:shadow-[#1EB97A]/20 transition-all duration-300 text-white placeholder-gray-500"
            ...
            <motion.div
                ...
                className="flex justify-end pt-6 border-t border-gray-800"
            >
                <motion.button

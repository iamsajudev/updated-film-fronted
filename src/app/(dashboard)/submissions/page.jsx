...
// Only import if window is available (client-side only)
const getToken = () => {
...
const SubmissionsPage = () => {
  ...
  useEffect(() => {
    ...
    if (token) {
      ...
      setLoading(false);
      setError('Please login to view your submissions');
    }
  }, []);
    ...
    try {
      ...
      if (data.success && data.data && data.data.length > 0) {
        const transformedSubmissions = data.data.map(project => ({
          ...
          festival: project.festivalName || 'Film Submission',
  ...
  const getStatusStyle = (status) => {
    switch (status) {
      ...
      case "Rejected": return "bg-emerald-100 text-emerald-700 border-emerald-200";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {!isAuthenticated && (
          <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
            ...
            <p className="text-blue-700 font-medium mb-2">Login Required</p>
            <p className="text-blue-600 text-sm mb-4">Please login to view your submissions</p>
            <Link href="/login">
        ...
        {/* Submissions Table - Only show if authenticated */}
        {isAuthenticated && (
      ...
      {viewModalOpen && selectedSubmission && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-white rounded-2xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            {/* Modal Header */}
            <div className="sticky top-0 bg-linear-to-r from-blue-600 to-blue-800 px-6 py-4 flex justify-between items-center">
